...
echo "Run this on the pos user account to setup hotkeys and node autostart if needed: curl -sSL https://raw.githubusercontent.com/Molesafenetwork/msnpos2/main/init.sh | bash "
